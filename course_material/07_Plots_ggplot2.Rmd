...
This section will provide more detail on creating graphics with ggplot2. This lesson is part of a detailed intro to r course put together by the BC government. You can find more details [here](https://github.com/bcgov/ds-cop-intro-to-r). 

This example required the dataset from
[gapminder.org](https://www.gapminder.org) containing population information for many
countries through time. Firstly you will need to download and save 
