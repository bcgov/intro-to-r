---
title: "Getting to know R and R-Studio"
...
This lesson will be an introduction to R and R-studio and how they can make your life 
easier! In this lesson we will get to know R and R-studio and some of the features you can use. 
...
the R language as well as some best practices for organizing code that will make your life easier.
...
ideas before adding them to an R script file. 
...
When using R as a calculator, there is an order of operations.
...
functionality better, or allow you to do new and amazing things with your phone.
...
## Challenge 5
 ...
 Install the following packages: `ggplot2` and `plyr`
